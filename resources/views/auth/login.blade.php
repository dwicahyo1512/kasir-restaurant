    ...
    <div class="flex h-screen">
        ...
        <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
            <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="949.85"
                    height="463.64" viewBox="0 0 949.85 463.64">
                    <path
                    ...
                    <path
                        ...
                        fill="#dfdfdf" stroke-width="0" />
                    <polygon points="838.74 152.18 824.02 157.02 824.02 135.82 837.38 135.82 838.74 152.18"
                    ...
                    <path
                        ...
                        fill="#36344e" stroke-width="0" />
                    <polygon points="863.24 226.57 801.92 226.57 820.32 147.3 847.03 147.3 863.24 226.57" fill="#6c63ff"
                        stroke-width="0" />
                    <path id="uuid-52db3307-ec3e-496d-a5d4-9d1f33ffc652-45-45-44-44"
                    ...
                    <path
                        ...
                        fill="#6c63ff" stroke-width="0" />
                    <path id="uuid-2800d917-a06e-4fc6-b661-0f9df9cadefc-46-46-45-45"
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <div class="mt-4 flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div class="w-full">
                        <Link href="/auth/github/redirect"
                            class="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                ...
                <x-splade-form action="{{ route('login') }}" class="space-y-4">
                    ...
                    {{-- <div>
                        ...
                        <x-splade-input id="name" type="text" name="name" required
                            autofocus />
                    </div> --}}
                    <div>
                    ...
                    <div class="flex flex-row">
                        <x-splade-checkbox id="remember_me" name="remember" :label="__('Remember me')"
                            class="w-100px flex items-center w-1/2" />
                        @if (Route::has('password.request'))
                            <Link
                                class="underline text-sm text-gray-600 text-right hover:text-gray-900 items-end w-1/2 min-w-screen "
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Don't have an account?
                        <Link href="{{ route('register') }}" class="text-black hover:underline">Register here</Link>
                    </p>
                </div>
            </div>
        </div>
