         ...
         <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
             ...
             <div
                 ...
                 <a href="https://vuejs.org/" class="flex justify-center items-center">
                    <img src="{{ asset('assets/vue.png') }}" alt="vue" class="max-w-64">
                 </a>
             </div>
         </div>
     </section>
         ...
         <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
             ...
             <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                 <div>
                     ...
                     <p class="text-gray-500 dark:text-gray-400">Antarmuka yang intuitif membuat pengguna dapat dengan cepat memahami dan menguasai sistem kasir kami.</p>
                 </div>
                 <div>
                     <div
                         class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                     ...
                     <p class="text-gray-500 dark:text-gray-400">Tim dukungan pelanggan kami siap membantu 24/7 untuk menangani pertanyaan, masalah, atau permintaan bantuan apapun.</p>
                 </div>
                 <div>
                     <div
                         class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                     ...
                     <p class="text-gray-500 dark:text-gray-400">RestoPos membantu mengoptimalkan operasional restoran Anda, mulai dari pengelolaan pesanan hingga manajemen inventori, sehingga Anda dapat fokus pada pertumbuhan bisnis Anda.</p>
                 </div>
             </div>
         </div>
     </section>
