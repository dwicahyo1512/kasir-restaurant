<x-splade-component is="button-with-dropdown" dusk="columns-dropdown">
    <x-slot:button>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"
            :class="{
                'text-base-content': !table.columnsAreToggled,
            ...
            @foreach($table->columns() as $column)
                ...
                <li class="py-2 flex items-center justify-between">
                    ...
                    <button
                        ...
                        :class="{
                            'bg-success': table.columnIsVisible(@js($column->key)),
                    ...
                    >
                        ...
                        <span
                            ...
                            class="inline-block h-5 w-5 rounded-full bg-success-content shadow transform ring-0 transition ease-in-out duration-300" />
                    </button>
                </li>
            @endforeach
        </ul>
