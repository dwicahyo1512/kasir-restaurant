...
class Client extends Controller
{
    ...
    {
        $this->middleware('can:read client_users', ['only' => ['client_users', 'store_users']]);
    }
    ...
    public function client_users()
    {
        ...
        $meja = Meja::where('status', 0)->get()->toArray();
        $pesanan = Kasir::with('meja')->latest()->take(10)->get()->toArray();
        return view('client_users', compact('menus', 'discounts', 'categories', 'pesanan', 'meja'));
    }
